...
def leftBoard():
    ...
    for box in range(0,11):
        if(box == 0):
            ...
            boxLabel = Label(gameWindow, font=("Helvetica",55), width=2, height=1, relief='ridge', borderwidth=1, bg="white")
...
def gameWindow():
    ...
    # rollButton = Button(gameWindow, text="Roll Dice", fg="black", font=("Chalkboard SE", 15), bg="gray", command=rollDice, width=20, height=20)
